...
execute @s[scores={playtime_award_m=3}] ~~~ scoreboard players add @s playtime_award_b 1
execute @s[scores={playtime_award_m=3}] ~~~ msg @s "You have been awarded a diamond for playtime; retrieve via the ATM at spawn"
execute @s[scores={playtime_award_m=3}] ~~~ scoreboard players set @s playtime_award_m 0
